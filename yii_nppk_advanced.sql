...
INSERT INTO `category` (`id`, `title`, `slug`, `template`, `published`, `sort_order`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	...
	(2, 'Специальности', 'professions', 1, 1, 2, 1, 1, 0, 0),
	(3, 'Мероприятия', 'mp', 1, 1, 3, 1, 1, 0, 0),
	(4, 'Галерея', 'gallery', 1, 0, 6, 1, 1, 0, 0),
	(5, 'О нас', 'about', 1, 1, 5, 1, 1, 0, 0),
	(6, 'Платное образование', 'platnoye-obrazovaniye', 1, 1, 1, 1, 1, 0, 0),
	(7, 'Наши достижения', 'nashi-dostzhenia', 1, 1, 7, 1, 1, 0, 0),
	(8, 'Меню', 'menu', 1, 0, 123, 1, 1, 1539148972, 1539148989);
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='Список групп учащихся';
...
-- Дамп данных таблицы yii_nppk_advanced.image: ~153 rows (приблизительно)
...
-- Дамп данных таблицы yii_nppk_advanced.user_group: ~3 rows (приблизительно)
