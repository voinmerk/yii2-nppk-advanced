...
INSERT INTO `category` (`id`, `title`, `slug`, `published`, `sort_order`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	(1, 'Новости', 'news', 0, 0, 1, 1, 0, 0),
	(2, 'Специальности', 'professions', 1, 2, 1, 1, 0, 0),
	(3, 'Мероприятия', 'mp', 1, 3, 1, 1, 0, 0),
	(4, 'Галерея', 'gallery', 0, 6, 1, 1, 0, 0),
	(5, 'О нас', 'about', 1, 5, 1, 1, 0, 0),
	(6, 'Платное образование', 'platnoye-obrazovaniye', 1, 1, 1, 1, 0, 0),
	(7, 'Наши достижения', 'nashi-dostzhenia', 1, 7, 1, 1, 0, 0),
	(8, 'Меню', 'menu', 0, 123, 1, 1, 1539148972, 1539148989);
...
-- Дамп структуры для таблица yii_nppk_advanced.menu
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  CONSTRAINT `FK_menu_page` FOREIGN KEY (`page_id`) REFERENCES `page` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы yii_nppk_advanced.menu: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `menu` DISABLE KEYS */;
INSERT INTO `menu` (`id`, `page_id`, `title`, `published`) VALUES
	(1, 1, 'О колледже', 1),
	(2, 4, 'Специальности', 1);
